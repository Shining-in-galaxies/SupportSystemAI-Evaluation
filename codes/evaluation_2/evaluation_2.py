...
def get_completion_from_messages(messages, model="gpt-3.5-turbo", temperature=0.4, max_tokens=1000):
...
# _______________Step 1: Run through the end-to-end system to answer the user query_________
import utils
customer_msg = f"""tell me about the smartx pro phone and the fotosnap camera, the dslr one. Also, what TVs or TV related products do you have?"""
...
# _______________End of Step 1______________


# _______________# Step 2: Evaluate the LLM's answer to the user with a rubric based on the extracted product information______________
cust_prod_info = {
...
def eval_with_rubric(test_set, assistant_answer):
    ...
    context = test_set.get('context', None)
...
# _______________________________End of Step 2_________________________________________


# _______________Step 3: Evaluate the LLM's answer to the user based on an ideal / expert answer (human generated) answer______________
test_set_ideal = {
    'customer_msg': """\
...
# evaluation_output = eval_with_rubric(test_set_ideal, assistant_answer)
# print(evaluation_output)
...
# _______________End of Step 3______________
